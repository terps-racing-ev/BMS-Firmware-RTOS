...
/* Definitions for CellTemperature */
osThreadId_t CellTemperatureHandle;
...
const osMutexAttr_t I2C1_attributes = {
  .name = "I2C1"
};
/* Definitions for I2C3 */
osMutexId_t I2C3Handle;
...
/**
* @brief Function implementing the CellVoltage thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the CellTemperature thread.
* @param argument: Not used
* @retval None
*/
