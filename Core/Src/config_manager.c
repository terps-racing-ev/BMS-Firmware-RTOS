...
uint32_t CAN_DS18B20_TEMP_ID = 0;
uint32_t CAN_DS18B20_DEBUG_ID = 0;
...
uint32_t CAN_CHIP_STATUS_ID = 0;
uint32_t CAN_VOLTAGE_BMS_1_SUMMARY_ID = 0;
uint32_t CAN_VOLTAGE_BMS_2_SUMMARY_ID = 0;
uint32_t CAN_BMS_HEARTBEAT_ID = 0;
uint32_t CAN_BMS_STATS_ID = 0;
uint32_t CAN_CONFIG_ACK_ID = 0;
uint32_t CAN_RESET_CMD_ID = 0;
uint32_t CAN_BMS_RESET_CMD_ID = 0;
uint32_t CAN_BMS_RESET_ACK_ID = 0;
uint32_t CAN_BALANCE_CMD_ID = 0;
uint32_t CAN_BALANCE_ACK_ID = 0;
uint32_t CAN_BALANCE_CFG_ID = 0;
uint32_t CAN_BALANCE_STATUS_ID = 0;
uint32_t CAN_BMS1_BAL_DETAIL_ID = 0;
uint32_t CAN_BMS2_BAL_DETAIL_ID = 0;
uint32_t CAN_DEBUG_RESPONSE_ID = 0;
uint32_t CAN_I2C_DIAG_ID = 0;
...
void Config_InitCANIDs(void)
{
    ...
    CAN_DS18B20_TEMP_ID = CAN_ID(CAN_DS18B20_TEMP_BASE, mod_id);
    CAN_DS18B20_DEBUG_ID = CAN_ID(CAN_DS18B20_DEBUG_BASE, mod_id);
    ...
    CAN_CHIP_STATUS_ID = CAN_ID(CAN_CHIP_STATUS_BASE, mod_id);
    CAN_VOLTAGE_BMS_1_SUMMARY_ID = CAN_ID(CAN_VOLTAGE_BMS_1_SUMMARY_BASE, mod_id);
    CAN_VOLTAGE_BMS_2_SUMMARY_ID = CAN_ID(CAN_VOLTAGE_BMS_2_SUMMARY_BASE, mod_id);
    ...
    CAN_BALANCE_CMD_ID = CAN_ID(CAN_BALANCE_CMD_BASE, mod_id);
    CAN_BALANCE_ACK_ID = CAN_ID(CAN_BALANCE_ACK_BASE, mod_id);
    CAN_BALANCE_CFG_ID = CAN_ID(CAN_BALANCE_CFG_BASE, mod_id);
    CAN_BALANCE_STATUS_ID = CAN_ID(CAN_BALANCE_STATUS_BASE, mod_id);
    CAN_BMS1_BAL_DETAIL_ID = CAN_ID(CAN_BMS1_BAL_DETAIL_BASE, mod_id);
    CAN_BMS2_BAL_DETAIL_ID = CAN_ID(CAN_BMS2_BAL_DETAIL_BASE, mod_id);
